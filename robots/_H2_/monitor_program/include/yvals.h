...
_STD_END
 ...
 #elif (!defined(__TMS320C27X__) && \
        !defined(__TMS320C5XX__)  && !defined(__MSP430__))
...
typedef _ULONGLONG _ULonglong;
   ...
   #if(defined(__TMS470__) || defined(__TMS320C6X__) || defined(__TMS320C28X__))
     typedef long long _Longlong;
     typedef unsigned long long  _ULonglong;
     #define _LLONG_MAX  0x7fffffffffffffff
     #define _ULLONG_MAX 0xffffffffffffffff
   #else /* ld, msp430, c27x and all others */
