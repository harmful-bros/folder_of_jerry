...
extern void InitEPwm(volatile struct EPWM_REGS *pPwmRegs);
...
#if DSP28_EQEP1
extern void InitEQep(volatile struct EQEP_REGS *pQepRegs);
...
extern void SpiLoadRom(Uint16 PageAdd, Uint16 BufAdd, Uint16 Number, Uint16 *pBuf);
extern void SpiSaveRom(Uint16 PageAdd, Uint16 BufAdd, Uint16 Number, Uint16 *pBuf);
