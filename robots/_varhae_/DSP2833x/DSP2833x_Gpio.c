...
void InitGpio(void)
{
   ...
   GpioCtrlRegs.GPADIR.all = 0x00000000;      // GPIO0-GPIO31 are inputs
   GpioCtrlRegs.GPBDIR.all = 0x00000000;      // GPIO32-GPIO63 are inputs   
   GpioCtrlRegs.GPCDIR.all = 0x00000000;      // GPI064-GPIO95 are inputs
...
//   GpioCtrlRegs.GPCPUD.all = 0x0000;      // Pullup's enabled GPIO64-GPIO79
  ...
  GpioCtrlRegs.GPAPUD.all = 0x7fffffff;    // Pullup's disabled GPIO0-GPIO31
  GpioCtrlRegs.GPBPUD.all = 0x00030000;    // Pullup's disabled GPIO32-GPIO63
  GpioCtrlRegs.GPCPUD.all = 0x00000000;     // Pullup's disabled GPIO64-GPIO79
