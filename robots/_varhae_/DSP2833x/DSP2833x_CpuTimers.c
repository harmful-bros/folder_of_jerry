...
void Init_ISR(void)
{
	DINT;
 	...
 	PieVectTable.ADCINT = &adc_timer_ISR; // Sensor interrupt
...
//	PieCtrlRegs.PIEIER1.bit.INTx1 = 1;//Motor interrupt
	...
	ConfigCpuTimer( &CpuTimer2, 150.0 , 250.0 );// motor int   500us
	ConfigCpuTimer( &CpuTimer0, 150.0 , 25.0 ); // start sensor interrupt 10us
