...
/*****************************************************************************/
/* For targets which do not have native float math function with suffix "f", */
/* replace them with the default double version function.                    */
/*****************************************************************************/
#define fabsf   fabs
#define acosf   acos
#define asinf   asin
...
/*****************************************************************************/
/* For targets which do not have native long double math function with suffix*/
/* "l", replace them with the default double version function.               */
/*****************************************************************************/
#define fabsl   fabs 
#define acosl   acos
#define asinl   asin
