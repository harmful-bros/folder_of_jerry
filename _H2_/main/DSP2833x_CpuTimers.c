...
void Init_ISR(void)
{
	...
	EALLOW;  // This is needed to write to EALLOW protected registers
 	...
 	PieVectTable.ADCINT = &adc_external_ISR; // Sensor interrupt
	EDIS;    // This is needed to disable write to EALLOW protected registers

//	IER |= M_INT14;
	IER |= ( M_INT1 | M_INT14 );//TINT0, TINT2 Enable

//	PieCtrlRegs.PIEIER1.bit.INTx1 = 1;//Motor interrupt
	PieCtrlRegs.PIEIER1.bit.INTx7 = 1;//Sensor interrupt
	PieCtrlRegs.PIEIER1.bit.INTx6= 1; //ADC interrupt
	
	ConfigCpuTimer( &CpuTimer2, 150.0 , 500.0 );// motor interrupt period 500us
	ConfigCpuTimer( &CpuTimer0, 150.0 , 50.0 ); // start sensor interrupt 50us
