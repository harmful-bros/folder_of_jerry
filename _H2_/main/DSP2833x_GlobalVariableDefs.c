...
#else
#pragma DATA_SECTION(LQepRegs,"EQep1RegsFile");
#endif
volatile struct EQEP_REGS LQepRegs;

//----------------------------------------
#ifdef __cplusplus
#pragma DATA_SECTION("EQep2RegsFile")
#else
#pragma DATA_SECTION(RQepRegs,"EQep2RegsFile");
#endif
volatile struct EQEP_REGS RQepRegs;
