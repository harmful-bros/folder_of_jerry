...
static void *_allocate_memory(size_t size)
{
 ...
 if (pnew == ((void *)0))
  goto error;
                              ...
                              ;
 __builtin___memset_chk (pnew, 0x00, size, __builtin_object_size (pnew, 0));
...
static int _find_to_matching_figure(FILE *pwrite, int n_case)
{
 ...
 __builtin___memset_chk ((void *)info, 0x00, sizeof(info), __builtin_object_size ((void *)info, 0));

 info[0].parr = (int *)_allocate_memory(sizeof(int) * n_case);
 info[1].parr = (int *)_allocate_memory(sizeof(int) * n_case);
 if (info[0].parr == ((void *)0) || info[1].parr == ((void *)0))
 {
                  ;
  goto error;
 }
...
int main(int argc, char *argv[])
{
 ...
 pread = freopen(argv[1], "r", __stdinp);
 if (pread == ((void *)0))
 {
               ;
  goto error;
 ...
 __builtin___snprintf_chk (write_str, sizeof(write_str), 0, __builtin_object_size (write_str, 2 > 1 ? 1 : 0), "%s.out", argv[1]);
